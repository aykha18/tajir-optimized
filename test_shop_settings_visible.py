#!/usr/bin/env python3
"""
Test checkboxes after making shop settings visible
"""
...
def test_shop_settings_visible():
    """Test checkboxes after making shop settings visible"""
    ...
    try:
        ...
        # Click on Shop Settings button
        print("⚙️ Clicking on Shop Settings button...")
        shop_settings_btn = driver.find_element(By.CSS_SELECTOR, "[data-go='shopSettingsSec']")
        ...
        # Take screenshot
        driver.save_screenshot("shop_settings_visible.png")
        print("📸 Screenshot saved as shop_settings_visible.png")
        
        # Check if shop settings section is visible
