...
This script runs the loyalty tables migration specifically for Railway PostgreSQL
"""
...
def get_railway_db_connection():
    ...
    try:
        # Use the direct Railway connection string provided by user
        ...
        print(f"   Host: hopper.proxy.rlwy.net")
        print(f"   Port: 46337")
        print(f"   Database: tajir_pos")
        ...
        print(f"❌ Failed to connect to Railway PostgreSQL: {e}")
        return None
...
def main():
    ...
    print("🚀 Railway Loyalty Tables Migration")
    print("=" * 50)
    
    # Connect to Railway PostgreSQL
    connection = get_railway_db_connection()
    if not connection:
